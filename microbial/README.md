...
5. `merge_table.py`: `python merge_table.py --clinical <path/to/clinical.csv> --kreport <path/to/kreport.txt> --wetlab-isolation <isolation.csv> --wetlab-yield <yield.csv> --stats <output/.../stats> --MT <FBI_output/output/02_tables/00_pipeline_postprocess/MT_DNA_load/> --output </path/to/output>`

6. `pathogen_table_new.py`: relative paths has been provided within the script. Execute by: `python pathogen_table_new.py`
